...
#pragma acc kernels loop create(a)
  for(i = 0; i < N; i++){
    a[i] = i + 3;
  }
  for(i = 0; i < N; i++){
...
int test_func(int a[N], char correct_val)
{
  int i;
  char results[4] = {0};
#pragma acc kernels loop pcopy(a)
  for(i = 0; i < N; i++){
    a[i] = i;
  }
  for(i = 0; i < N; i++){
...
#pragma acc kernels loop pcopyin(a)
  for(i = 0; i < N; i++){
    a[i] = i + 1;
  }
  for(i = 0; i < N; i++){
...
#pragma acc kernels loop pcopyout(a)
  for(i = 0; i < N; i++){
    a[i] = i + 2;
  }
  for(i = 0; i < N; i++){
...
#pragma acc kernels loop pcreate(a)
  for(i = 0; i < N; i++){
    a[i] = i + 3;
  }
  for(i = 0; i < N; i++){
...
{
  int i;
#pragma acc kernels loop deviceptr(dev_a)
  for(i = 0; i < N; i++){
    dev_a[i] = i * 3;
  }
}